...
```
{: #example-no-provisioning-partner title="Credential transfer without Provisioning Partner"}
...
```
{: #example-transfer-with-intermediary title="Credential transfer with intermediary server"}
...
```
{: #example-transfer-directly title="Credential transfer without intermediary"}
