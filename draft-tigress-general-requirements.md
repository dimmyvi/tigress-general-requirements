...
{: #example-no-provisioning-partner title="Credential transfer directly between 2 devices"}
...
{: #example-transfer-with-intermediary title="Credential transfer through intermediary server"}
...
{: #example-transfer-directly title="Credential transfer directly between 2 devices"}
